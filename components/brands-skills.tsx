...
const brands = [
  { name: "Godrej",                     logo: img("/images/godrej.jpg"),                                     whiteBg: true },
  { name: "DLF",                        logo: img("/images/dlf.svg"),                                        whiteBg: true },
  { name: "M3M",                        logo: img("/images/m3m.jpg"),                                        whiteBg: true },
  { name: "Gaurs",                      logo: img("/images/gaurs.png"),                                      whiteBg: true },
  ...
  { name: "Cheesecake & Co.",           logo: img("/images/cheesecake.jpg"),                                 whiteBg: true },
  { name: "Apara",                      logo: img("/images/apara.png"),                                     whiteBg: true },
  { name: "Stockify",                   logo: img("/images/stockify.png"),                                   whiteBg: true },
  { name: "BOP Realty",                 logo: img("/images/boplog.jpg"),                                    whiteBg: true },
  { name: "Counsel India",              logo: img("/images/counselindialogo.jpg"),                           whiteBg: true },
  { name: "Upskill Lab",                logo: img("/images/upskill.png"),                                    whiteBg: true },
  { name: "Social Banana",              logo: img("/images/socialbananalogo.png"),                          whiteBg: true },
